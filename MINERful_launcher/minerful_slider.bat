...
set INPUT_LOG=...\Data\sepsis\sepsis.xes
...
set RESULTS=...\Data\sepsis\output_minerful_sepsis.csv
...
set MINERFUL_JAR=...\MINERful\MINERful\MINERful.jar
REM #Replace for the absolute path of MINERful lib 
set LIB_FOLDER=...MINERful\MINERful\lib
